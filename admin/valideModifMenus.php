...
if ($_SERVER["REQUEST_METHOD"] == "POST") {
    ...
    $compositions = $_POST['composition'];
    $prixs = $_POST['prix'];
    ...
    for ($i = 0; $i < count($ids); $i++) {
        ...
        if ($modifier) {
            ...
            $sql = "UPDATE Menus SET nom = '$nom', description = '$description', formule = '$formule', periode = '$periode', composition = '$composition', prix = '$prix' WHERE id = $id";
